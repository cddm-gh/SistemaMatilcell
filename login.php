					...
					<div class="collapse navbar-collapse" id="navbar-1">
						...
						<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"  
							...
							<div class="form-group has-feedback">
								...
								<input type="text" class="form-control" id="usuario" name="usuario" placeholder="Usuario" maxlenght="10" required="true">
								<i class="glyphicon glyphicon-user form-control-feedback"></i>
							</div>
							<div class="form-group has-feedback">
								<label class="control-label" for="usuario"></label>
								<input type="password" name="password" class="form-control" id="password" placeholder="Password" maxlenght="10" required="true">
